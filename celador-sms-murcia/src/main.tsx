    ...
    <>
      ...
      <main className="lm-page lm-sms" id="contenido">
        ...
        <section className="lm-shell lm-seo-copy" aria-labelledby="seo-title">
          ...
          <div><p>La convocatoria del Servicio Murciano de Salud fija un ejercicio de 75 preguntas en 85 minutos. El curso sigue sus materias comunes y específicas para que estudies, practiques y midas cada vuelta.</p></div>
        </section>
