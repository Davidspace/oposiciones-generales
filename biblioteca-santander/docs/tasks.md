...
- [x] Clonar la superficie de Auxilio en un directorio independiente.
- [x] Sustituir textos, metadatos, fuentes y llamadas a la acción por Santander.
- [x] Crear muestra gratuita propia sobre programa, catálogos y referencias.
- [x] Añadir paleta diferenciada sin alterar el sistema visual compartido.
