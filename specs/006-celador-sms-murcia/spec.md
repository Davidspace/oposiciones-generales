...
4. **Given** la persona abre la landing o llega a la prueba, **when** todavía no ha pulsado «Comenzar la prueba», **then** el contador permanece detenido en 17:00.
...
- **FR-003b**: El temporizador debe comenzar únicamente cuando la persona pulsa el control explícito de inicio de la prueba.
